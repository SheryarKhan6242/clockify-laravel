$(function() {
    ...
    c3.generate({
        ...
        donut: { label: { show: !1 }, width: 18 },
        legend: { hide: !0 },
        color: { pattern: ["#113607", "#27C278"] }
    }), d3.select("#annual-leave .c3-chart-arcs-title").style("font-family", "Rubik");
