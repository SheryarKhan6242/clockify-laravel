...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h2 class="page-title text-truncate text-light font-weight-medium mb-1">Add Employee</h2>
        </div>
    </div>
</div>
...
<div class="row">
                    ...
                    <div class="card-body" style="height:348px; overflow: auto;">
                        ...
                        <div class="row flex-column pt-3">
                            <div class="form-group mb-3">
                                ...
                                {{ aire()->email('personal_email')->placeholder('Enter Personal Email')->id('personal_email')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="cnic">CNIC</label>
                                {{ aire()->input('cnic_no')->placeholder('Enter CNIC No')->id('cnic_no')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="dob">Date Of Birth</label>
                                {{ aire()->date('date_of_birth')->placeholder('Dob')->id('date_of_birth')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="mobile-no">Personal Phone No</label>
                                {{ aire()->input('mobile_no')->placeholder('Enter Phone No')->id('mobile_no')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="emergency-no">Emergency No</label>
                                {{ aire()->input('emergency_no')->placeholder('Enter Emergency No')->id('emergency_no')->class('form-control pt-1') }}

                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="personal_address">Permanent Address</label>
                                {{ aire()->input('permanent_address')->placeholder('Enter Permanent Address')->id('permanent_address')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="linkedin">Linkedin Id</label>
                                {{ aire()->input('linkedin')->placeholder('Enter Full Name')->id('linkedin')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="skype">Skype Id</label>
                                {{ aire()->input('skype')->placeholder('Enter Full Name')->id('skype')->class('form-control pt-1') }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body" style="height:348px; overflow: auto;">
                        ...
                        <div class="row flex-column pt-3">
                            <div class="form-group mb-3">
                                ...
                                {{ aire()->input('salary')->placeholder('Enter Salary')->id('salary')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="acc_holder">Account Holder name</label>
                                {{ aire()->input('acc_holder')->placeholder('Enter Account Holder Name')->id('acc_holder')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="acc_no">Account No + Branch Code</label>
                                {{ aire()->input('acc_no')->placeholder('Enter account no + branch code / IBAN No')->id('acc_no')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="branch_location">Branch Location</label>
                                {{ aire()->input('branch_location')->placeholder('Enter branch location')->id('branch_location')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="branch_name">Branch Name</label>
                                {{ aire()->input('branch_name')->placeholder('Enter branch name')->id('branch_name')->class('form-control pt-1') }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body" style="height:348px; overflow: auto;">
                        ...
                        <div class="row flex-column pt-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                {{ aire()->email('user_email')->placeholder('Enter official email')->id('user_email')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="dep_id">Department</label>
                                {{ aire()->select(Department::all()->pluck('name', 'id')->prepend('Select Department', ''),'dep_id')->id('dep_id')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                {{ aire()->select(Shift::all()->pluck('name', 'id')->prepend('Select Employee Shift', ''),'shift_id')->id('shift_id')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="joining_date">Date Of Joining</label>
                                {{ aire()->date('joining_date')->placeholder('Joining Date')->id('joining_date')->class('form-control pt-1') }}
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="alternative_no">Office No</label>
                                {{ aire()->input('alternative_no')->placeholder('Enter Office No')->id('alternative_no')->class('form-control pt-1') }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-4">
        <div class="card text-center pt-3 pb-2">
            <div class="card-body">
                {{-- <a class="" href="#">
                    <img src="{{ asset('assets/images/widgets/add-image.svg')}}" alt="user" class="employee-image rounded-circle mx-auto" width="140" height="140" />
                </a> --}}
                {{-- <label for="file-input" class="upload-label">
                    <input type="file" id="file-input" style="display: none;" accept="image/*">
                    <img src="{{ asset('assets/images/widgets/add-image.svg')}}" alt="user" class="employee-image rounded-circle mx-auto" width="140" height="140" id="uploaded-image">
                    <img src="{{ asset('assets/images/icons/edit-image.svg')}}" alt="edit-icon" class="edit-icon">
                  </label> --}}
                        ...
                        <div class="col-sm-6" style="position: relative;">
                            ...
                            <ul class="list-style-none mt-4">
                                <li class="d-flex align-items-center">
                                    ...
                                    <span class="text-light ms-2 font-weight-medium avail-annual">(--)</span>
                                </li>
                                <li class="mt-2 d-flex align-items-center">
                                    <i class="fas fa-circle text-danger font-10 me-2"></i>
                                    <span class="text-muted">Remaining</span>
                                    <span class="text-light ms-2 font-weight-medium rem-annual">(--)</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6" style="position: relative;">
                            ...
                            <ul class="list-style-none mt-4">
                                <li class="d-flex align-items-center">
                                    <i class="fas fa-circle text-cyan font-10 me-2"></i>
                                    <span class="text-muted">Availed:</span>
                                    <span class="text-light ms-2 font-weight-medium avail-sick">(--)</span>
                                </li>
                                <li class="mt-2 d-flex align-items-center">
                                    <i class="fas fa-circle text-danger font-10 me-2"></i>
                                    <span class="text-muted">Remaining</span>
                                    <span class="text-light ms-2 font-weight-medium rem-sick">(--)</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-style-none mt-4">
                        <li class="d-flex align-items-center">
                            <i class="fas fa-circle text-cyan font-10 me-2"></i>
                            <span class="text-muted">Availed:</span>
                            <span class="text-light ms-2 font-weight-medium">(--)</span>
                        </li>
                        <li class="mt-2 d-flex align-items-center">
                            <i class="fas fa-circle text-danger font-10 me-2"></i>
                            <span class="text-muted">Remaining</span>
...
//         uploadedImage.classList.remove('employee-image');
//       }
//     };
