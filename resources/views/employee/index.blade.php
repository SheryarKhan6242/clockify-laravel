                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <span class="svg-icon svg-icon-1 position-absolute ms-6 position-relative"
                                    style="left: 42.5%; top: 20%;">
                                ...
                                <input type="text" name="searchTerm"
                                    id="searchTerm"class="form-control rounded w-50 ps-14" placeholder="Search Employee"
                                    autocomplete="off">
                            </div>
                            <!--end::Search-->
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <!--begin::Add user-->
                                <a href="#add_emp_modal" class="btn btn-primary fw-bold" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <div class="row g-9">
                        ...
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-bold">
                                Username<span class="required text-danger">*</span>
                            </label>
                        ...
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-bold">
                                DOB<span class="required text-danger">*</span>
                            </label>
                            {{ aire()->date('dob')->placeholder('DOB')->id('dob')->class('form-control form-control-solid')->required() }}
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-bold">
                                Permanent Address<span class="required text-danger">*</span>
                            </label>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            {{ aire()->input('temporary_address')->placeholder('Residential Address')->id('temporary_address')->class('form-control form-control-solid')->required() }}
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-bold">
                                Marital Status<span class="required text-danger">*</span>
                            </label>
                        ...
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-bold">
                                Work Type<span class="required text-danger">*</span>
                            </label>
                    ...
                    <div class="text-center pt-15 show_update">
                        ...
                        <a href="#" onclick="storeEmp()" class="btn btn-rounded btn-success btn-change">Add
                            Employee</a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <div class="text-center pt-15 show_update">
                        <a href="#" id="btnClosePopup" class="btn btn-rounded btn-danger btnClosePopup">Cancel</a>
                        <a href="#" id="update_emp" onclick="updateEmp()"
                            class="btn btn-rounded btn-success btn-change">Update Employee</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fetch_data(page, search_item) {
                ...
                $.ajax({
                    url: "{{ url('/employee/load-emp-table?page=') }}" + page + "&search_item=" +
                        search_item,
        ...
        $('#work_type').change(function() {
            ...
            if (selectedValue === 'Part Time') {
                ...
                var newDiv = $(
                    '<div class="row g-9 pb-2"><div class="col-md-6 fv-row"><label class="fs-6 fw-bold"><span class="required">Per Day Hours*</span></label><input type="number" id="per_day_hours" name="per_day_hours" class="form-control form-control-solid" /></div></div>'
                );
            ...
            // Check if the value is Hybrid
                ...
                var newDiv = $(
                    '<div class="row g-9 pb-2"><div class="col-md-6 fv-row"><label class="fs-6 fw-bold"><span class="required">Weekdays*</span></label><div style="display: inline-flex;"><label style="padding: 0 10px;"><input type="checkbox" name="weekday[]" value="Monday" /> Monday</label><label style="padding: 0 10px;"><input type="checkbox" name="weekday[]" value="Tuesday" /> Tuesday</label><label style="padding: 0 10px;"><input type="checkbox" name="weekday[]" value="Wednesday" /> Wednesday</label><label style="padding: 0 10px;"><input type="checkbox" name="weekday[]" value="Thursday" /> Thursday</label><label style="padding: 0 10px;"><input type="checkbox" name="weekday[]" value="Friday" /> Friday</label></div></div></div>'
                ); // var newDiv = $('<div class="row g-9"><div class="col-md-6 fv-row"><label class="fs-6 fw-bold"><span class="required">Weekdays*</span></label><br /><input type="checkbox" name="weekday[]" value="Monday" /> Monday<br /><input type="checkbox" name="weekday[]" value="Tuesday" /> Tuesday<br /><input type="checkbox" name="weekday[]" value="Wednesday" /> Wednesday<br /><input type="checkbox" name="weekday[]" value="Thursday" /> Thursday<br /><input type="checkbox" name="weekday[]" value="Friday" /> Friday</div></div>');
                // Insert the new div after the work type div
                $('.work-type-add').append(newDiv)
            }
