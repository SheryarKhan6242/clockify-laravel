...
@section('content')
    ...
    <div class="card">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <a href="{{ route('roles-management.create') }}"
                        class="btn btn-secondary fw-bolder fs-8 fs-lg-base ms-5">
        ...
        <div class="card-body pt-0">
            @include('roles-management.include.tableData')
        </div>
    </div>
    <!--end::Content-->
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, search_item) {
                ...
                $.ajax({
                    url: "{{ url('/dashboard/roles-management/load-role-table?page=') }}" +
                        page +
